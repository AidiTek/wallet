...
import com.example.wallet.databinding.FragmentConectingWithDeveloperBinding
import com.example.wallet.presentation.activity.MainActivity

class conectingWithDeveloperFragment : Fragment() {

    private var _binding: FragmentConectingWithDeveloperBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentConectingWithDeveloperBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbarTitle.text = "Связаться с разработчиком"
