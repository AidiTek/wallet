...
class FragmentYearGraphics : Fragment() {

    private var _binding: FragmentYearGraphicsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentYearGraphicsBinding.inflate(inflater, container, false)
        return binding.root
    }
