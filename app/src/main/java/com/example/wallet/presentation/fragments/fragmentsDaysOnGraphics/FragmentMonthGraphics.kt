...
class FragmentMonthGraphics : Fragment() {

    private var _binding: FragmentMonthGraphicsBinding? = null
    ...
    override fun onCreateView(
       ...
       _binding = FragmentMonthGraphicsBinding.inflate(inflater,container,false)
        return binding.root
    }
